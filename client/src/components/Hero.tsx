...
export default function Hero() {
  ...
  return (
    <section className="relative flex flex-col items-center w-full bg-white dark:bg-[#0A0A0A] py-16 px-6 md:py-[100px] md:px-[120px] overflow-hidden transition-colors duration-300">
      {/* Badge */}
